...
from sklearn.model_selection import LeaveOneOut,LeaveOneGroupOut, GroupShuffleSplit
...
df = pd.read_csv("../data/EMIMCmdiop_celldensities_nosubsetting.csv",index_col=0)
y =  pd.read_csv(f"../data/ControlVsEM.csv",index_col=0).EM
